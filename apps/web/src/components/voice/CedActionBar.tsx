...
export function CedActionBar({
  ...
  return (
    <nav
      ...
      className="pointer-events-auto fixed inset-x-0 bottom-0 z-50 border-t border-[var(--studio-border)] bg-[var(--studio-sidebar)] px-2 pt-1.5 backdrop-blur-md pb-[max(0.5rem,env(safe-area-inset-bottom))]"
    >
