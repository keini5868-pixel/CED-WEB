...
export function CedHudQuickPopups({
  ...
  const openLifeChat = (prompt?: string, module?: "weather" | "calendar" | "events" | "gmail") => {
      ...
      <div className={popupShell} onClick={(e) => e.stopPropagation()}>
        ...
        {active === "calendar" ? (
          <>
            ...
            <div className="mt-3 border-t border-cyan-900/50 pt-2">
              <p className="text-[10px] text-cyan-400/90">➕ Nuevo evento (Google Calendar):</p>
            ...
            <div className="mt-2 border-t border-cyan-900/50 pt-2">
              <HudPopupButton
                ...
                onClick={() => openLifeChat("¿qué eventos tengo esta semana?", "calendar")}
              />
            </div>
          </>
        ) : null}
        ...
        {active === "events" ? (
          <>
            ...
            <p className="mt-1 text-[10px] text-cyan-400/70">Notas personales — sin Google Calendar</p>
        ...
        {active === "gmail" ? (
          <>
            ...
            <div className="mt-3 border-t border-cyan-900/50 pt-2">
              <p className="text-[10px] text-cyan-400/90">Enviar:</p>
            ...
            <HudPopupButton
              label="Leer"
              onClick={() => openLifeChat("¿qué emails importantes tengo sin leer?", "gmail")}
            />
          </>
        ) : null}
