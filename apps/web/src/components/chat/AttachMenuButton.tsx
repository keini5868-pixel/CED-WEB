    ...
    <>
      ...
      <div ref={rootRef} className={clipOnly ? "relative" : "relative lg:hidden"}>
        ...
        <button
          ...
          className={
            clipOnly
              ? "box-border flex h-[1.375rem] w-[1.375rem] shrink-0 items-center justify-center rounded-full border border-[var(--studio-border)] bg-[var(--studio-composer-bg)] text-[var(--ced-cyan)] hover:bg-[var(--ced-cyan)]/10 active:scale-95 disabled:opacity-40 lg:h-8 lg:w-8"
              : triggerClass
          }
