-- Idempotente si 029 ya se aplicó con esta lógica.
-- Si 029 se aplicó con trial_ends_at = 24 h, esto corrige el trigger
-- y añade columnas del reloj de voz (primer uso).
