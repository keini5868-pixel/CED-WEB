...
def address_context_for_prompt(user_id: str) -> str:
    ...
    return (
        ...
        f"- Saludo Modo Jarvis (exacto al conectar): \"{jarvis_greeting}\"\n"
        f"- Saludo estándar (exacto al conectar): \"{standard_greeting}\"\n"
        + (f"- {gender_note}\n" if gender_note else "")
        + "\n"
        "Reglas de tratamiento:\n"
        "- Usa el tratamiento indicado en saludos y durante la conversación.\n"
