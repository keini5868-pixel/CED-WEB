...
EXECUTION_MESSAGES: dict[str, str] = {
    ...
    "search_nearby_places": "Buscando lugares cerca, señor",
    "start_navigation": "Calculando ruta, señor",
    "stop_navigation": "Un momento, señor",
    "navigation_status": "Consultando ruta, señor",
...
TIMEOUT_MS: dict[str, int] = {
    ...
    "search_nearby_places": 15_000,
    "start_navigation": 20_000,
    "iniciar_navegacion": 20_000,
    "stop_navigation": 5_000,
    "navigation_status": 5_000,
    ...
    "consultar_pagos_pendientes": 12_000,
}
